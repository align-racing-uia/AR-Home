                ...
                this.axios
                    ...
                    .then(response => {
                        ...
                        for (var i = 0; i < events.length; i++) {
                            let time = new Date(events[i].time).toISOString().substring(0,10);

                            this.events.push({name: events[i].title, start: time})
                        }

                        this.events.push({name: 'TESTTT', start: '2019-01-01'})
